  ...
  <v-container>
      <v-row justify="center" class="my-10">
        <v-col cols="8">
          ...
          <v-toolbar flat>
            <v-spacer></v-spacer>
            <v-toolbar-title class="text-h5 font-weight-bold pt-3">에피소드 등록</v-toolbar-title>
            <v-spacer></v-spacer>
          </v-toolbar>
    ...
    <v-row>
      <v-col cols="4" class="d-flex text-center text-h6">
        <v-card elevation="0" class="ma-auto">에피소드 소개<br />(50자 이상)</v-card>
      </v-col>
   ...
   <!-- 에피소드 썸내일과 에피소드 웹툰 올리기 --> 
    <v-row class="mb-5" justify="center">
      <v-col cols="6" class="d-flex text-center text-h6">
        <v-card elevation="0" class="ma-auto">에피소드 썸내일<br />(260px * 260px)
          <v-file-input
            id="thumbnail"
            truncate-length="15"
          ></v-file-input>
      ...
      <v-col cols="6" class="d-flex text-center text-h6">
        <v-card elevation="0" class="ma-auto">에피소드 이미지<br />(1280px * (max)5120px)
          <v-file-input
            id="episodeI"
            truncate-length="15"
            multiple
   ...
   <v-row>
      ...
      <v-spacer></v-spacer>
      <v-col>
        <router-link to="/webtoon_home_writer" style="text-decoration:none">
          <v-btn
            depressed
            x-large
            block
