<template>
  ...
  <div id="background">
    ...
    <v-container>
      <v-row justify="center" class="mt-10">
        <v-col cols="8">
          ...
          <v-toolbar flat>
            <v-spacer></v-spacer>
            <v-toolbar-title class="text-h5 font-weight-bold pt-3">작가 신청</v-toolbar-title>
            <v-spacer></v-spacer>
          </v-toolbar>
    ...
    <v-row>
      <v-col cols="4" class="d-flex text-center text-h6">
        <v-card elevation="0" class="ma-auto">소개글<br />(100자 이상)</v-card>
      </v-col>
    ...
    <v-row class="mb-5">
      <v-col cols="4" class="d-flex text-center text-h6">
        <v-card elevation="0" class="ma-auto">프로필 사진<br />(200px * 200px)</v-card>
      </v-col>
      <!-- <v-col cols="4">
        <v-img
